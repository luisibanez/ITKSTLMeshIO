...
public:
  ...
  */
   ...
   * operations. */
  void ReadPointData( void * itkNotUsed(buffer) ) override {};
  void ReadCellData( void * itkNotUsed(buffer) ) override {};
   ...
   * Therefore the following two methods are implemented as null
   * operations. */
  void WritePointData( void * itkNotUsed(buffer) ) override {};
  void WriteCellData( void * itkNotUsed(buffer) ) override {};
